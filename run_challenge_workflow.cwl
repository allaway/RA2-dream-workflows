  ...
  run_docker:
    ...
    in:
      ...
      - id: synapse_config
        source: "#synapseConfig"
      - id: train_dir
        valueFrom: "/data/project/RA2_DREAM/post_challenge_validation_adjusted/train"
      - id: test_dir
        valueFrom: "/data/project/RA2_DREAM/post_challenge_validation_adjusted/test"
    out:
      - id: predictions
  ...
  validation:
    ...
    in:
      ...
      - id: goldstandard
        default:
          class: File
          location: "/data/project/RA2_DREAM/post_challenge_validation_adjusted/test1.csv"
    out:
      - id: results
      - id: status
      - id: invalid_reasons
