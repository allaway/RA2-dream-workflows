...
steps:
  ...
  notify_participants:
    run: https://raw.githubusercontent.com/Sage-Bionetworks/ChallengeWorkflowTemplates/synapse-docker/notification_email.cwl
    in:
      - id: submissionid
        source: "#submissionId"
      - id: synapse_config
  ...
  score_email:
    ...
    in:
      ...
      - id: private_annotations
        valueFrom: ['sc2_joint_weighted_sum_rmse', 'sc2_hand_weighted_sum_rmse', 'sc2_foot_weighted_sum_rmse', 'sc3_joint_weighted_sum_rmse', 'sc3_hand_weighted_sum_rmse', 'sc3_foot_weighted_sum_rmse']
    out: []
